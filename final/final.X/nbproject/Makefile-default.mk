...
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/_ext/470364171/actuators.o ${OBJECTDIR}/_ext/1062335525/uart.o ${OBJECTDIR}/_ext/731469447/hallClock.o ${OBJECTDIR}/_ext/731469447/timer_libs.o ${OBJECTDIR}/_ext/725581128/create_normal_message.o ${OBJECTDIR}/_ext/725581128/send_receive_messages.o ${OBJECTDIR}/_ext/219456723/desiredValues.o ${OBJECTDIR}/_ext/219456723/schedules.o ${OBJECTDIR}/_ext/299869866/adc_init.o ${OBJECTDIR}/_ext/299869866/air_quality_level.o ${OBJECTDIR}/_ext/299869866/i2c.o ${OBJECTDIR}/_ext/299869866/motion_detection.o ${OBJECTDIR}/_ext/299869866/temp_analog.o ${OBJECTDIR}/_ext/299869866/temp_digital.o ${OBJECTDIR}/_ext/341829419/statemachine_airquality_control.o ${OBJECTDIR}/_ext/708645397/statemachine_airtemp_control.o ${OBJECTDIR}/_ext/1770285118/statemachine_light_control.o ${OBJECTDIR}/_ext/1013356857/statemachine_watertemp_control.o ${OBJECTDIR}/_ext/754508808/update.o ${OBJECTDIR}/main.o
...
# Object Files
OBJECTFILES=${OBJECTDIR}/_ext/470364171/actuators.o ${OBJECTDIR}/_ext/1062335525/uart.o ${OBJECTDIR}/_ext/731469447/hallClock.o ${OBJECTDIR}/_ext/731469447/timer_libs.o ${OBJECTDIR}/_ext/725581128/create_normal_message.o ${OBJECTDIR}/_ext/725581128/send_receive_messages.o ${OBJECTDIR}/_ext/219456723/desiredValues.o ${OBJECTDIR}/_ext/219456723/schedules.o ${OBJECTDIR}/_ext/299869866/adc_init.o ${OBJECTDIR}/_ext/299869866/air_quality_level.o ${OBJECTDIR}/_ext/299869866/i2c.o ${OBJECTDIR}/_ext/299869866/motion_detection.o ${OBJECTDIR}/_ext/299869866/temp_analog.o ${OBJECTDIR}/_ext/299869866/temp_digital.o ${OBJECTDIR}/_ext/341829419/statemachine_airquality_control.o ${OBJECTDIR}/_ext/708645397/statemachine_airtemp_control.o ${OBJECTDIR}/_ext/1770285118/statemachine_light_control.o ${OBJECTDIR}/_ext/1013356857/statemachine_watertemp_control.o ${OBJECTDIR}/_ext/754508808/update.o ${OBJECTDIR}/main.o
