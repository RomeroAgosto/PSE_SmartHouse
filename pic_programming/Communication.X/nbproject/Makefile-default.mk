...
SOURCEFILES_QUOTED_IF_SPACED=../CKCommon/UART/uart.c message.c main.c send_receive_messages.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/_ext/1062335525/uart.o ${OBJECTDIR}/message.o ${OBJECTDIR}/main.o ${OBJECTDIR}/send_receive_messages.o
POSSIBLE_DEPFILES=${OBJECTDIR}/_ext/1062335525/uart.o.d ${OBJECTDIR}/message.o.d ${OBJECTDIR}/main.o.d ${OBJECTDIR}/send_receive_messages.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/_ext/1062335525/uart.o ${OBJECTDIR}/message.o ${OBJECTDIR}/main.o ${OBJECTDIR}/send_receive_messages.o

# Source Files
SOURCEFILES=../CKCommon/UART/uart.c message.c main.c send_receive_messages.c
...
${OBJECTDIR}/message.o: message.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} "${OBJECTDIR}/message.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -DPK3OBPlatformTool=1  -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/message.o.d" -o ${OBJECTDIR}/message.o message.c    -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD) 
