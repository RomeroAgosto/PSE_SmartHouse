...
int i2c4_setClock(unsigned int clock_freq){
    // Write I2C1BRG
...
void i2c4_stop(void){
    ...
    while( (I2C4CON & 0x1F) != 0);
    I2C4CONbits.PEN=1;
    while(I2C4CONbits.PEN==1);
    return;


}
int i2c4_send(unsigned char value){
...
char i2c4_receive(char ack_bit){
    ...
    while( (I2C4CON & 0x1F) != 0);
    I2C4CONbits.RCEN=1;
    while(I2C4STATbits.RBF == 0);
    I2C4CONbits.ACKDT=ack_bit;
    I2C4CONbits.ACKEN = 1;
