...
SOURCEFILES_QUOTED_IF_SPACED=main.c schedules.c get_schedules.c message.c desiredValues.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/main.o ${OBJECTDIR}/schedules.o ${OBJECTDIR}/get_schedules.o ${OBJECTDIR}/message.o ${OBJECTDIR}/desiredValues.o
POSSIBLE_DEPFILES=${OBJECTDIR}/main.o.d ${OBJECTDIR}/schedules.o.d ${OBJECTDIR}/get_schedules.o.d ${OBJECTDIR}/message.o.d ${OBJECTDIR}/desiredValues.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/main.o ${OBJECTDIR}/schedules.o ${OBJECTDIR}/get_schedules.o ${OBJECTDIR}/message.o ${OBJECTDIR}/desiredValues.o

# Source Files
SOURCEFILES=main.c schedules.c get_schedules.c message.c desiredValues.c
...
${OBJECTDIR}/schedules.o: schedules.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} "${OBJECTDIR}/schedules.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -DICD3PlatformTool=1  -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/schedules.o.d" -o ${OBJECTDIR}/schedules.o schedules.c    -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD) 
	
${OBJECTDIR}/get_schedules.o: get_schedules.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/get_schedules.o.d 
	@${RM} ${OBJECTDIR}/get_schedules.o 
	@${FIXDEPS} "${OBJECTDIR}/get_schedules.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -DICD3PlatformTool=1  -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/get_schedules.o.d" -o ${OBJECTDIR}/get_schedules.o get_schedules.c    -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD) 
...
${OBJECTDIR}/desiredValues.o: desiredValues.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} "${OBJECTDIR}/desiredValues.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -DICD3PlatformTool=1  -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/desiredValues.o.d" -o ${OBJECTDIR}/desiredValues.o desiredValues.c    -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD) 
...
${OBJECTDIR}/get_schedules.o: get_schedules.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/get_schedules.o.d 
	@${RM} ${OBJECTDIR}/get_schedules.o 
	@${FIXDEPS} "${OBJECTDIR}/get_schedules.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/get_schedules.o.d" -o ${OBJECTDIR}/get_schedules.o get_schedules.c    -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD) 
