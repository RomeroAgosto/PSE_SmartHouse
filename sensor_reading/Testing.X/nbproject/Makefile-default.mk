...
# Source Files
SOURCEFILES=adc_init.c air_quality_level.c i2c1.c i2c1_s7.c i2c1_s8.c main.c motion_detection.c temp_analog.c temp_digital.c hallClock.c timer_libs.c desiredValues.c update.c ../../pic_programming/CKCommon/UART/uart.c
...
${OBJECTDIR}/i2c1.o: i2c1.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/i2c1.o 
	@${FIXDEPS} "${OBJECTDIR}/i2c1.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/i2c1.o.d" -o ${OBJECTDIR}/i2c1.o i2c1.c    -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD) 
	
${OBJECTDIR}/i2c1_s7.o: i2c1_s7.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/i2c1_s7.o.d 
	@${RM} ${OBJECTDIR}/i2c1_s7.o 
	@${FIXDEPS} "${OBJECTDIR}/i2c1_s7.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/i2c1_s7.o.d" -o ${OBJECTDIR}/i2c1_s7.o i2c1_s7.c    -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD) 
	
${OBJECTDIR}/i2c1_s8.o: i2c1_s8.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/i2c1_s8.o.d 
	@${RM} ${OBJECTDIR}/i2c1_s8.o 
	@${FIXDEPS} "${OBJECTDIR}/i2c1_s8.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/i2c1_s8.o.d" -o ${OBJECTDIR}/i2c1_s8.o i2c1_s8.c    -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD) 
...
${OBJECTDIR}/hallClock.o: hallClock.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} "${OBJECTDIR}/hallClock.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/hallClock.o.d" -o ${OBJECTDIR}/hallClock.o hallClock.c    -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD) 
...
${OBJECTDIR}/_ext/670234849/uart.o: ../../pic_programming/CKCommon/UART/uart.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/_ext/670234849" 
	@${RM} ${OBJECTDIR}/_ext/670234849/uart.o.d 
	@${RM} ${OBJECTDIR}/_ext/670234849/uart.o 
	@${FIXDEPS} "${OBJECTDIR}/_ext/670234849/uart.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/_ext/670234849/uart.o.d" -o ${OBJECTDIR}/_ext/670234849/uart.o ../../pic_programming/CKCommon/UART/uart.c    -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD) 
...
${OBJECTDIR}/_ext/670234849/uart.o: ../../pic_programming/CKCommon/UART/uart.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/_ext/670234849/uart.o.d 
	@${RM} ${OBJECTDIR}/_ext/670234849/uart.o 
	@${FIXDEPS} "${OBJECTDIR}/_ext/670234849/uart.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/_ext/670234849/uart.o.d" -o ${OBJECTDIR}/_ext/670234849/uart.o ../../pic_programming/CKCommon/UART/uart.c    -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD) 
